  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="px-4 pb-20">
        ...
        <section className="mb-6">
          <div className="bg-gray-900 text-white p-4 rounded-lg flex items-center justify-between" onClick={() => navigate('/purpose')}>
            <div className="flex items-center space-x-3" >
              <Calculator size={20} />
        ...
        <section className="mb-6">
          <div className="grid grid-cols-2 gap-3">
            <button onClick={() => navigate('/finance')} className="bg-gray-900 text-white p-4 rounded-lg flex items-center justify-center space-x-2">
              <Calculator size={20} />
              <span className="font-medium">FINANCIAL</span>
            </button>
            <button onClick={() => navigate('/insurance')} className="bg-gray-900 text-white p-4 rounded-lg flex items-center justify-center space-x-2">
              <Shield size={20} />
        ...
        <section className="mb-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <ChevronRight size={20} className="text-gray-400 cursor-pointer" onClick={() => navigate('/purposeloan')} />
          </div>
          <Swiper
          ...
          >
            {articles.map((article, index) => (
              <SwiperSlide key={index}>
                <Link to={'/description'} state={{ item: article }}>
                  <div className="bg-white rounded-lg overflow-hidden shadow-sm border h-full cursor-pointer">
                    <img
                      src={article.image}
                      alt={article.title}
                      className="w-full h-32 object-cover"
                    />
                    <div className="p-3 flex flex-col justify-between" style={{ minHeight: '130px' }}>
                      <div>
                      ...
                      <div className="flex items-center justify-between text-xs text-gray-400 mt-auto">
                        <span>Published by {article.publishedBy}</span>
